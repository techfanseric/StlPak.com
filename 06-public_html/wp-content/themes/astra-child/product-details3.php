...
get_header();
// Template Name: Product Details 3
?>
	...
	<div class="container">
		<div class="row cust-row">
			...
			<div class="col-sm-12 col-md-5 responsiveMargin MTdiamondList">
				...
				<div class="MTdetailPageText"><?php the_field('page_description');?></div>
				<div class="MTpageDetails"><?php the_field('page_details');?></div>
		...
		<div class="row cust-row">
			...
			<div class="col-sm-12 col-md-4 responsiveMargin">
				<div class="MTcatalogBox text-center">
					...
					<div class="MTcatalogImg"><img src="<?php echo $catalogImg['url'];?>" alt="<?php echo $catalogImg['alt'];?>" width="<?php echo $catalogImg['width']; ?>" height="<?php echo $catalogImg['height']; ?>"></div>
					<?php if(get_field('catalog_button_text')):?>
						<div class="MTcatalogBtn"><a href="<?php the_field('catalog_link');?>" class="commonBtn" target="_blank"><?php the_field('catalog_button_text');?></a></div>
					<?php endif; ?>
				</div>
			</div>
		</div>
...
<div class="pc3RepeatSection paddTop70 paddBottom70 <?php if($counter%2 == 1){echo 'greySection';} ?>">
...
<div class="MTDetailVideoSection paddTop60 paddBottom60">
	<div class="container">
		<?php $section4Img = get_field('video_image') ?>
		...
		<?php else: ?>
		<div class="pc3Section3img"><img src="<?php echo $section4Img['url']; ?>" alt="<?php echo $section4Img['alt']; ?>" width="<?php echo $section4Img['width']; ?>" height="<?php echo $section4Img['height']; ?>"></div>
		<?php endif; ?>
	</div>
</div>
<?php endif; ?>
				...
				<ul class="img4Slider">
					...
					<li class="slide">
						<div class="dp4relatedProduct">
							<?php $slider_image = get_sub_field('image') ?>
							<div class="dp4relatedProductImg"><a href="<?php the_sub_field('link');?>"><img src="<?php echo $slider_image['url']; ?>" alt="<?php echo $slider_image['alt']; ?>"></a></div>
